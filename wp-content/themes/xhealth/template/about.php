		...
		<div class="aboutus-content">
			...
			<div class="gallery">
				...
				<div class="author-card">
					<a href="<?php echo get_author_posts_url($st['ID']); ?>" class="image-fit"><img src="<?php echo $avt['url']; ?>" alt="<?php echo $avt['alt']; ?>"></a>
					<h4><a href="<?php echo get_author_posts_url($st['ID']); ?>"><?php echo $st['display_name']; ?></a></h4>
