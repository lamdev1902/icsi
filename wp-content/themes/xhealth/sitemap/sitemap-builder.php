...
class GoogleSitemapGeneratorStandardBuilder {
	...
	public function BuildPosts($gsg, $params) {
	    ...
	    $query = "SELECT COUNT( ID )
	                ...
	                AND post_type IN ('post','page','single_reviews','round_up','informational_posts','coupon')
		...
		if($postCount > 0) {
			if($level == 1) {
				...
				$args = array(
					'post_type' => array('post','page','single_reviews','round_up','informational_posts','coupon'),
					'suppress_filters' => false,
